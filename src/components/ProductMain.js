    ...
    <section id="three" className="wrapper special">
        <div className="inner">
            ...
            <div className="flex flex-2">
                ...
                <article>
                    <Link to='/locador/suporte transbike'>
                        <div className="image fit">
                ...
                <article>
                    <Link to='/locador/bagageiro carga'>
                        <div className="image fit">
                ...
                <article>
                    <Link to='/locador/bagageiro mala'>
                        <div className="image fit">
